...
class HomeCategoryAdapter (val context: Context,val sendId:SendId): RecyclerView.Adapter<HomeCategoryAdapter.Define>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeCategoryAdapter.Define {
        val categoryLayout= LayoutInflater.from(context).inflate(R.layout.layout_home_catogories,parent,false)
